...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "services_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar
  ...
  CREATE TABLE "_services_v_version_populated_authors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_uuid" varchar,
  ...
  CREATE INDEX "services_populated_authors_order_idx" ON "services_populated_authors" USING btree ("_order");
  CREATE INDEX "services_populated_authors_parent_id_idx" ON "services_populated_authors" USING btree ("_parent_id");
  ...
  CREATE INDEX "_services_v_version_populated_authors_order_idx" ON "_services_v_version_populated_authors" USING btree ("_order");
  CREATE INDEX "_services_v_version_populated_authors_parent_id_idx" ON "_services_v_version_populated_authors" USING btree ("_parent_id");
  ...
  CREATE INDEX "_services_v_rels_users_id_idx" ON "_services_v_rels" USING btree ("users_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "services_populated_authors" CASCADE;
  DROP TABLE "services" CASCADE;
  DROP TABLE "services_rels" CASCADE;
  DROP TABLE "_services_v_version_populated_authors" CASCADE;
